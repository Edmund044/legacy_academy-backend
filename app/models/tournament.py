...
class Tournament(Base):
    ...
    format: Mapped[TournamentFormat] = mapped_column(Enum(TournamentFormat,name='tournament_format'), nullable=False)
    status: Mapped[TournamentStatus] = mapped_column(Enum(TournamentStatus,name='tournament_status'), nullable=False, default=TournamentStatus.planned, index=True)
...
class Match(Base):
    ...
    status: Mapped[MatchStatus] = mapped_column(Enum(MatchStatus,name='match_status'), nullable=False, default=MatchStatus.scheduled, index=True)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, server_default=func.now())
