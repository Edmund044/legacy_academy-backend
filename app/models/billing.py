...
class Subscription(Base):
    ...
    plan_type: Mapped[SubPlan] = mapped_column(Enum(SubPlan,name='sub_plan'), nullable=False)
    ...
    status: Mapped[SubStatus] = mapped_column(Enum(SubStatus,name='sub_status'), nullable=False, default=SubStatus.active, index=True)
...
class AttendanceBilling(Base):
    ...
    billing_status: Mapped[BillingStatus] = mapped_column(Enum(BillingStatus,name='billing_status'), nullable=False, default=BillingStatus.pending, index=True)
...
class Invoice(Base):
    ...
    status: Mapped[InvoiceStatus] = mapped_column(Enum(InvoiceStatus,name='invoice_status'), nullable=False, default=InvoiceStatus.draft, index=True)
...
class RevenueSplit(Base):
    ...
    payout_status: Mapped[PayoutStatus] = mapped_column(Enum(PayoutStatus,name='payout_status'), nullable=False, default=PayoutStatus.pending, index=True)
...
class Payment(Base):
    ...
    status: Mapped[PaymentStatus] = mapped_column(Enum(PaymentStatus,name='payment_status'), nullable=False, default=PaymentStatus.pending, index=True)
