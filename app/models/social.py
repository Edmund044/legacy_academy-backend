...
class Disbursement(Base):
    ...
    category: Mapped[DisbCategory] = mapped_column(Enum(DisbCategory,name='disb_category'), nullable=False, index=True)
...
class SponsorshipCase(Base):
    ...
    status: Mapped[CaseStatus] = mapped_column(Enum(CaseStatus,name='case_status'), nullable=False, default=CaseStatus.active, index=True)
