...
class Transaction(Base):
    ...
    transaction_type: Mapped[str] = mapped_column(Enum(TransactionType,name="transactiontype"), nullable=False)
    category: Mapped[str] = mapped_column(Enum(TransactionCategory,name="transactioncategory"), nullable=False)
...
class Loan(Base):
    ...
    status: Mapped[str] = mapped_column(Enum(LoanStatus,name='loanstatus'), default=LoanStatus.PENDING)
