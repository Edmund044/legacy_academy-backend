...
class SessionEnrollment(Base):
    ...
    billing_method: Mapped[BillingMethod] = mapped_column(Enum(BillingMethod,name='billing_method'), nullable=False)
...
class Drill(Base):
    ...
    intensity: Mapped[DrillIntensity] = mapped_column(Enum(DrillIntensity,name='drill_intensity'), nullable=False, default=DrillIntensity.medium)
