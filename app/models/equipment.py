...
class EquipmentItem(Base):
    ...
    category: Mapped[EquipCategory] = mapped_column(Enum(EquipCategory,name="equip_category"), nullable=False, index=True)
    ...
    condition: Mapped[EquipCondition] = mapped_column(Enum(EquipCondition,name="equip_condition"), nullable=False, default=EquipCondition.good)
...
class EquipmentHandover(Base):
    ...
    status: Mapped[HandoverStatus] = mapped_column(Enum(HandoverStatus,name="handover_status"), nullable=False, default=HandoverStatus.checked_out, index=True)
...
class HandoverItem(Base):
    ...
    condition_out: Mapped[EquipCondition] = mapped_column(Enum(EquipCondition,name="equip_condition"), nullable=False)
    condition_in: Mapped[EquipCondition | None] = mapped_column(Enum(EquipCondition,name="equip_condition"), nullable=True)
