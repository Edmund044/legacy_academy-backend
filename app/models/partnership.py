...
class Contract(Base):
    ...
    payment_cycle: Mapped[PaymentCycle] = mapped_column(Enum(PaymentCycle,name='paymentcycle'), nullable=False)
    ...
    status: Mapped[ContractStatus] = mapped_column(Enum(ContractStatus,name='contractstatus'), nullable=False, default=ContractStatus.draft, index=True)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, server_default=func.now())
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, server_default=func.now(), onupdate=func.now())
